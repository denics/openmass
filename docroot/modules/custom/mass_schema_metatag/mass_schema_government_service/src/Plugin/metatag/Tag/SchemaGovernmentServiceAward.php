...
/**
 * Provides a plugin for the 'schema_government_service_award' meta tag.
 *
 ...
 *
 * @MetatagTag(
 *   id = "schema_government_service_award",
 ...
 * )
 */
class SchemaGovernmentServiceAward extends SchemaNameBase {
